...
public class Driver {
	...
	private int age;
	private final static String DRIVERLISTCSV= "D:/listDrivers.csv"; 
	private final static String AVAILABLEDRIVERSCSV= "D:/availableDrivers.csv"; 
	private final static String RESERVEDDRIVERCSV = "D:/reservedDrivers.csv"; 
	...
	public String toString() {
		return firstName + "," + lastName + "," + nic + "," + phoneNumber + "," + age;
	}
}
